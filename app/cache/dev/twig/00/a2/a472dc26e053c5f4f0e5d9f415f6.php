...
\t\t\t\t\t<h2>";
        // line 144
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "oQuestion"), "getLibelleMasculin", array(), "method"), "html", null, true);
        echo "</h2>
\t\t\t\t\t<br/>
...
\t\t\t\t\t\t";
        ...
        $context['_seq'] = twig_ensure_traversable(range(4, 6));
...
\t\t\t\t\t\t";
        // line 270
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable(range(7, 9));
        foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
            // line 271
            echo "\t\t\t\t\t\t\t<div class=\"row-fluid\">
\t\t\t\t\t\t\t\t<div class=\"span12\">
...
\t\t\t\t\t\t";
        // line 290
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable(range(10, 12));
        foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
            // line 291
            echo "\t\t\t\t\t\t\t<div class=\"row-fluid\">
\t\t\t\t\t\t\t\t<div class=\"span12\">
...
\t\t\t\t\t\t";
        // line 310
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable(range(13, 15));
        foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
            // line 311
            echo "\t\t\t\t\t\t\t<div class=\"row-fluid\">
\t\t\t\t\t\t\t\t<div class=\"span12\">

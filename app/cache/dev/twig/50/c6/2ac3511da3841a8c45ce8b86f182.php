...
/* DMCCategorieBundle:Article:frontAffichage.html.twig */
class __TwigTemplate_50c62ac3511da3841a8c45ce8b86f182 extends Twig_Template
{
...
\t<link rel=\"stylesheet\" href=\"";
        // line 4
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("bundles/dmccategorie/css/style_frontArticle.css"), "html", null, true);
...
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t<div class=\"span6\">
\t\t\t\t\t\t\t\t<p class=\"bordureGrise fondBlanc\">
...
\t\t\t\t\t</div>
\t\t\t\t\t<div class=\"span4\">
\t\t\t\t\t\t<h5>Darty possede 356 Articles comme</h5>\t\t\t\t\t\t
\t\t\t\t\t\t<ul class=\"thumbnails\">
\t\t\t\t\t\t\t<li class=\"span1\">
\t\t\t\t\t\t\t\t<div class=\"thumbnail\">
\t\t\t\t\t\t\t\t\t<img src=\"http://www.darty.com/res3/views_mobile/common/img/big_logo.jpg\" alt=\"\">
...
";
    ...
    {
        return "DMCCategorieBundle:Article:frontAffichage.html.twig";
    }
